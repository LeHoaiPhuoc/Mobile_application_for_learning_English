...
import hi.do_an_2.Controller.ListView_xem_video_Adapter;
...
public class Xem_video_Activity extends AppCompatActivity {
    ...
    public void addEvent() {
        lvXemVideo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ListView_xem_video video = listViewXemVideoList.get(position);
    ...
    public void loadTenVideo(String fileName) {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                if (line.equals("****")) {
                    ...
                    if (!tenVideoList.contains(tenVideo)) {
                        ...
                        listViewXemVideoList.add(new ListView_xem_video(drawableResourceId, tenVideo));
                    }
                }
            }
        ...
        ListView_xem_video_Adapter adapter = new ListView_xem_video_Adapter(this, R.layout.item_listview_xem_video, listViewXemVideoList);
