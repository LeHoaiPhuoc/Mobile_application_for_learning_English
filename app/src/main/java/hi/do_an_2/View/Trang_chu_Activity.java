...
import hi.do_an_2.Controller.ListView_app_trang_chu_Adapter;
import hi.do_an_2.Controller.MenuApp_trang_chu_Adapter;
...
public class Trang_chu_Activity extends AppCompatActivity {
    GridView gvTrangChu;
    ArrayList<Menu_app_trang_chu> menuAppArrayList;
    MenuApp_trang_chu_Adapter adapteMenuAppTrangChu;
    ListView lv;
    ArrayList<ListView_app_trang_chu> listViewAppTrangChuArrayList;
    ListView_app_trang_chu_Adapter adapterListViewAppTrangChu;
    Button btnDangXuat;
    ...
    public void loadDataGridView(){
        ...
        menuAppArrayList.add(new Menu_app_trang_chu(R.drawable.them_tu_vung,"Thêm","từ vựng"));
        menuAppArrayList.add(new Menu_app_trang_chu(R.drawable.hoc_tu_vung,"Học","từ vựng"));
        menuAppArrayList.add(new Menu_app_trang_chu(R.drawable.xem_video_tieng_anh,"Xem video","tiếng Anh"));
        menuAppArrayList.add(new Menu_app_trang_chu(R.drawable.doc_truyen_tieng_anh,"Đọc truyện","tiếng Anh"));

        adapteMenuAppTrangChu = new MenuApp_trang_chu_Adapter(this, R.layout.item_gridview_trang_chu, menuAppArrayList);
        gvTrangChu.setAdapter(adapteMenuAppTrangChu);
    }
    public void loadDataListView(){
        listViewAppTrangChuArrayList = new ArrayList<>();
        listViewAppTrangChuArrayList.add(new ListView_app_trang_chu(R.drawable.thong_ke,R.drawable.thong_ke_2, "Thống kê"));
        adapterListViewAppTrangChu = new ListView_app_trang_chu_Adapter(this, R.layout.item_listview_trang_chu, listViewAppTrangChuArrayList);
