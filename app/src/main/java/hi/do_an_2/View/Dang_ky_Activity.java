...
public class Dang_ky_Activity extends AppCompatActivity {
    ...
    MySQLite_open_helper databaseHelper;
    ...
    public void addControls(){
        ...
        databaseHelper = new MySQLite_open_helper(this);
    ...
    private boolean kiemTraTenDangNhap(String tenDangNhap){
        ...
        if(cursor != null && cursor.moveToFirst()){
            do{
                @SuppressLint("Range") String tenDangNhapDB =cursor.getString(cursor.getColumnIndex(MySQLite_open_helper.COLUMN_TEN_DANG_NHAP));
